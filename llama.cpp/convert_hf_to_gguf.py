...
class Model:
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        if chkhsh == "0ef9807a4087ebef797fc749390439009c3b9eda9ad1a097abbe738f486c01e5":
            # ref: https://huggingface.co/maum-ai/Llama-3-MAAL-8B-Instruct-v0.1
            res = "llama-3-MAAL"
        if chkhsh == "a8297dffdb5f59a3fc40f9e3a75fc62490baf12985e34040f2041d3c86077fee":
            # ref: https://huggingface.co/jhgan/ko-sroberta-multitask
            res = "ko-sroberta-multitask"
